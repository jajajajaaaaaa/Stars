    ...
    public partial class Form1 : Form
    {
        ...
        private void MoveStar(Star star)
        {
            ...
            if (star.Z < 1)
            {
                ...
                star.Y = random.Next(-pictureBox1.Height, pictureBox1.Width);
            }
        }
        ...
        private void DrawStar(Star star)
        {
            ...
            graphics.FillEllipse(Brushes.LightGoldenrodYellow, x, y, starSize, starSize);
        }
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < stars.Length; i++)
            {
                stars[i] = new Star()
                {
                    ...
                    Y = random.Next(-pictureBox1.Height, pictureBox1.Width),
